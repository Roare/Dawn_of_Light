...
namespace DOL.GS.GameEvents
{
	...
	public class ParchmentEvent
	{
		...
		private static ItemTemplate[] m_items = { UtilityScrollsEvent.HealerScroll, UtilityScrollsEvent.MerchantScroll, UtilityScrollsEvent.TeleporterScroll, UtilityScrollsEvent.Tinderbox, UtilityScrollsEvent.TrainerScroll, UtilityScrollsEvent.VaultKeeperScroll, LootGeneratorRam.Ram};
