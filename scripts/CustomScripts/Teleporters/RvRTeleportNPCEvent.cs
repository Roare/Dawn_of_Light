...
namespace DOL.GS.GameEvents
{
	public class RvRTeleportNPCEvent
	{
		...
		public static void OnScriptCompiled(DOLEvent e, object sender, EventArgs args)
		{
			...
			m_albLocs.Add(new Location("Housing", 2, 572048, 569356, 3520, 736));
			...
			m_midLocs.Add(new Location("Housing", 102, 526733, 561643, 3632, 736));
			...
			m_hibLocs.Add(new Location("Hibernia Housing", 202, 555538, 526481, 3008, 736));
