								...
								case "all":
									{
										...
										{
											if (!PrivilegeMgr.IsGameMaster(allplayer))
											{
							...
							case "albs":
								{
									foreach (GameClient aplayer in WorldMgr.GetClientsOfRealm(eRealm.Albion))
									{
										if (aplayer.Player.IsAlive && !PrivilegeMgr.IsGameMaster (aplayer))
										{
							...
							case "mids":
								{
									foreach (GameClient mplayer in WorldMgr.GetClientsOfRealm(eRealm.Midgard))
									{
										if (mplayer.Player.IsAlive && !PrivilegeMgr.IsGameMaster (mplayer))
										{
							...
							case "hibs":
								{
									foreach (GameClient hplayer in WorldMgr.GetClientsOfRealm(eRealm.Hibernia))
									{
										if (hplayer.Player.IsAlive && !PrivilegeMgr.IsGameMaster (hplayer))
										{
							...
							case "all":
								{
									foreach (GameClient allplayer in WorldMgr.GetAllPlayingClients())
									{
										if (allplayer.Player.IsAlive && !PrivilegeMgr.IsGameMaster (allplayer))
										{
