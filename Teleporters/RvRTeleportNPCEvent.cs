...
namespace DOL.GS.GameEvents
{
	public class RvRTeleportNPCEvent
	{
		...
		public static ArrayList AlbLocs
		{
			get { return m_albLocs; }
		}
		protected static ArrayList m_midLocs = new ArrayList();
		public static ArrayList MidLocs
		{
			get { return m_midLocs; }
		}
		protected static ArrayList m_hibLocs = new ArrayList();
		public static ArrayList HibLocs
		{
			get { return m_hibLocs; }
		}
		...
		public static void OnScriptCompiled(DOLEvent e, object sender, EventArgs args)
		{
			...
			//m_albLocs.Add(new LocationExpansion("Cathal Valley (40-49)", 165, 583159, 585478, 4896, 2417, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.NewFrontiers, GameClient.eClientVersion.Version185, 40, 49));
			...
			AbstractGameKeep bgAPK = GetBGPK(1);
			m_albLocs.Add(new LocationExpansion(bgAPK.CurrentZone.Description, bgAPK.CurrentRegion.ID, bgAPK.X, bgAPK.Y, bgAPK.Z, (ushort)bgAPK.Heading, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.NewFrontiers, GameClient.eClientVersion.Version170, 36, 50));
			m_albLocs.Add(new LocationExpansion("Caerwent", 2, 556483, 559261, 3646, 2940, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.Foundations, GameClient.eClientVersion.Version168));
			...
			AbstractGameKeep bgMPK = GetBGPK(2);
			m_midLocs.Add(new LocationExpansion(bgMPK.CurrentZone.Description, bgMPK.CurrentRegion.ID, bgMPK.X, bgMPK.Y, bgMPK.Z, (ushort)bgMPK.Heading, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.NewFrontiers, GameClient.eClientVersion.Version170, 36, 50));
			...
			m_midLocs.Add(new LocationExpansion("Erikstaad", 102, 553194, 566166, 3650, 524, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.Foundations, GameClient.eClientVersion.Version168));
			...
			AbstractGameKeep bgHPK = GetBGPK(3);
			m_hibLocs.Add(new LocationExpansion(bgHPK.CurrentZone.Description, bgHPK.CurrentRegion.ID, bgHPK.X, bgHPK.Y, bgHPK.Z, (ushort)bgHPK.Heading, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.NewFrontiers, GameClient.eClientVersion.Version170, 36, 50));
			...
			m_hibLocs.Add(new LocationExpansion("Meath", 202, 564857, 559680, 3008, 481, GameClient.eClientType.ShroudedIsles, GameClient.eClientAddons.Foundations, GameClient.eClientVersion.Version168));
		...
		private static AbstractGameKeep GetBGPK(byte realm)
		{
			foreach (AbstractGameKeep keep in KeepMgr.GetKeepsOfRegion(KeepMgr.getKeepByID(ServerRules.DOLServerRules.BG_KEEP_ID).CurrentRegion.ID))
			{
				if ((byte)keep.OriginalRealm == realm && keep.IsPortalKeep)
					return keep;
			}
			return null;
		}
